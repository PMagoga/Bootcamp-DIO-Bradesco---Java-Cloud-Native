...
import com.example.dto.BoardColumnInfoDTO;
import com.example.exception.CardBlockedException;
import com.example.exception.CardFinishedException;
import com.example.exception.EntityNotFoundException;
import com.example.persistence.dao.BlockDAO;
import com.example.persistence.dao.CardDAO;
...
import static com.example.persistence.entity.BoardColumnKindEnum.CANCEL;
import static com.example.persistence.entity.BoardColumnKindEnum.FINAL;
...
public class CardService {
    ...
    public void moveToNextColumn(final Long cardId, final List<BoardColumnInfoDTO> boardColumnsInfo) throws
            SQLException {
        try{
            var dao = new CardDAO(connection);
